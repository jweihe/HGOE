...
# def get_mix_ood_dataset(args, train_per=0.9, need_str_enc=True):
...
def get_ood_dataset(args, train_per=0.9, need_str_enc=True):
    ...
    # # 计算dataset中的平均节点数和平均边数
    # avg_nodes_dataset, avg_edges_dataset = calculate_graph_statistics(dataset)

    # # 计算dataset_ood中的平均节点数和平均边数
    # avg_nodes_dataset_ood, avg_edges_dataset_ood = calculate_graph_statistics(dataset_ood)

    # # 打印结果
    # print("平均节点数(dataset):", avg_nodes_dataset)
    # print("平均边数(dataset):", avg_edges_dataset)
    # print("平均节点数(dataset_ood):", avg_nodes_dataset_ood)
    # print("平均边数(dataset_ood):", avg_edges_dataset_ood)
